    ...
    <div style={{ backgroundColor: '#F5F6F8', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '800px', margin: '0 auto', width: '100%' }}>
          <Link href="/home" className="link-profile-back" style={{ display: 'inline-flex', alignItems: 'center', color: 'rgba(255,255,255,0.8)', textDecoration: 'none', fontWeight: 500, fontSize: '14px', transition: 'color 0.2s', marginBottom: '24px' }}>
